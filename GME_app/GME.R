        ...
        tabPanel("Informação",
                 fluidPage(
                   ...
                   textAreaInput("pesquisador", h2("Nome do pesquisador"), 
                                 value = "Digite o nome do pesquisador...", width = "80%"),
                   textAreaInput("titulo", h2("Título do projeto"), 
                                 value = "Digite o título do projeto...", width = "80%"),
                   textAreaInput("financiamento", h2("Financiamento"), 
                                 value = "Digite os financiamentos separados por ponto e vígula...", width = "80%"),
                   textAreaInput("resumo", h2("Resumo do experimento"), 
                                 value = "Digite resumo...", width = "80%"),
                   textAreaInput("metodo", h2("Metodologia"), 
                                 value = "Digite a metodologia...", width = "80%"),
                   textAreaInput("equipamento", h2("Equipamento utilizado"), 
                                 value = "Digite sobre o equipamento utilizado", width = "80%"),
                   textAreaInput("detalhes", h2("Detalhes específicos do equipamento"), 
                                 value = "Digite detalhes se houver...", width = "80%"),
                   textAreaInput("grupos", h2("Grupos ou genótipos do experimento"), 
                                 value = "Digite grupos ou genótipos separados por ponto e vígula...", width = "80%"),
                   textAreaInput("outras", h2("Outras informações do experimento"), 
                                 value = "Digite outras informações do experimento...", width = "80%"),
                   textAreaInput("analise", h2("Análise de dados"), 
                                 value = "Indique qual análise esta sendo feita com os dados neste folder...", width = "80%"),
                   textAreaInput("software", h2("Software"), 
                                 value = "Indique software utilizados para visiualizar os dados...", width = "80%")
                 )
        ),
